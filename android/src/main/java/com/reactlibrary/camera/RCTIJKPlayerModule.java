...
public class RCTIJKPlayerModule extends ReactContextBaseJavaModule {
    ...
    public void start(final ReadableMap options, final Promise promise) {
        ...
        if(RCTIJKPlayer.getViewInstance() != null)
        {
          final String URL = options.getString("url");
          final String USER = options.getString("user");
          final String PASS = options.getString("pass");

          RCTIJKPlayer.getViewInstance().start(URL, USER, PASS);
